<div>
    <div class="modal-header">
        <h4 class="modal-title w-100 text-caixaAzul text-futurabold" id="modal_demanda">@if($demanda_id) Alterar @else Nova @endif Demanda</h4>
            ...
            <div class="mb-2 text-sm">
                ...
                @if(sizeof($demandaExistentes) > 0)
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3 ">
                            ...
                            <select class="browser-default custom-select @error('demanda_antiga') is-invalid @enderror" wire:model="demanda_antiga" wire:loading.attr="disabled" required>
                            ...
                            @error('demanda_antiga') <div class="invalid-feedback is-invalid">{{ $message }}</div>@enderror
                        </div>
                    </div>
                    <hr>
                @endif
                <div class="form-row">
                    <div class="col-md-12 mb-3 ">
                        ...
                        <select class="browser-default custom-select @error('sistema_id') is-invalid @enderror" wire:model="sistema_id" wire:loading.attr="disabled" @if($demanda_antiga) disabled @endif required>
                        ...
                        @error('sistema_id') <div class="invalid-feedback is-invalid">{{ $message }}</div>@enderror
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-12 mb-3 ">
                        ...
                        <select class="browser-default custom-select @error('categoriaSelecionado') is-invalid @enderror" wire:model="categoriaSelecionado" wire:loading.attr="disabled" @if($demanda_antiga) disabled @endif required>
                        ...
                        @error('categoriaSelecionado') <div class="invalid-feedback is-invalid">{{ $message }}</div>@enderror
                    </div>
                </div>
                @endif
                ...
                <div class="form-row">
                    <div class="col-md-12 mb-3 ">
                        ...
                        <select class="browser-default custom-select @error('subcategoriaSelecionado') is-invalid @enderror" wire:model="subcategoriaSelecionado" wire:loading.attr="disabled" @if($demanda_antiga) disabled @endif required>
                        ...
                        @error('subcategoriaSelecionado') <div class="invalid-feedback is-invalid">{{ $message }}</div>@enderror
                    </div>
                </div>
                @endif
                ...
                <div class="form-row">
                    <div class="col-md-12 mb-3 ">
                        <label class="active">Item</label>
                        <select class="browser-default custom-select @error('sistema_item_id') is-invalid @enderror" wire:model.debounce.defer="sistema_item_id" wire:loading.attr="disabled" wire:target="subcategoriaSelecionado" wire:target="categoriaSelecionado" @if($demanda_antiga) disabled @endif required>
                        ...
                        @error('sistema_item_id') <div class="invalid-feedback is-invalid">{{ $message }}</div>@enderror
                    </div>
                </div>
                @endif
                <div class="form-row">
                    <div class="col-md-12 mb-3 ">
                        ...
                        <textarea wire:model.debounce.defer="descricao" wire:loading.attr="disabled" class="form-control @error('descricao') is-invalid @enderror" id="exampleFormControlTextarea5" rows="3" @if($demanda_antiga) disabled @endif></textarea>
    ...
    <div class="modal-footer justify-content-between">
        <div class="d-inline-block">
            @if($demanda_id)
                <button onclick="excluirDemanda({{ $demanda_id }})" type="button" class="btn btn-danger btn-sm float-left">Excluir demanda</button>
            @endif
        </div>
        <div class="d-inline-block">
