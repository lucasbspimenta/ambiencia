            ...
            <div class="list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-between">
                    ...
                    <div class="flex-shrink-1">
                        @if (trim($demanda->migracao) == 'A')
                            <span class="badge badge-info z-depth-0" style="font-size:85%">Aguardando finalização</span>
                        @endif
                ...
                <div class="d-flex w-100 justify-content-between">
                    ...
                    @if (trim($demanda->migracao) != 'C')
                        <button onclick="excluirDemanda({{ $demanda->id }},@this)" type="button"
                        ...
                        <div>
                            <span class="badge badge-primary z-depth-1 p-2 font-weight-normal mr-2">
                                ...
                                @if ($demanda->respostas->where('checklist_id', $checklist->id)->count() > 1)
                                    <a class="align-self-stretch"
                                        onclick="excluirVinculacao({{ $demanda->id }},@this,{{ $resposta->id }})"><i
                                            class="fa fa-times text-white font-weight-bold ml-1"
