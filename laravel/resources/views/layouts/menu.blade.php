    ...
    <ul class="navbar-nav mr-auto">
        ...
        @if (Auth::check() && Auth::user()->is_admin)
            <x-header.menuitem nome='Administração' nomerota='index' icone='cogs' badge=''>
                <x-header.menusubitem nome='Tipos de Agendamento'
                    descricao='Inclusão e alteração dos tipos de atendimentos' nomerota="adm.tipodeagendamento"
                    icone='calendar-day' badge='' />
                <x-header.menusubitem nome='Itens do Checklist' descricao='Inclusão e alteração dos itens do checklist'
                    nomerota='adm.checklist.index' icone='list-alt' badge='' />
                <x-header.menusubitem nome='Guias' descricao='Inclusão e alteração dos itens do guia'
                    nomerota='adm.guia.indexadm' icone='book' badge='' />
            </x-header.menuitem>
        @endif
    </ul>
</div>
